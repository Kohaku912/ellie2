...
Usage:
  ...
  .\\.venv\\Scripts\\python apps\\cli.py --file instruction.txt
  Get-Content instruction.txt | .\\.venv\\Scripts\\python apps\\cli.py --stdin
"""
...
from ellie.core.instruction_runner import InstructionRunner, format_result_for_cli
